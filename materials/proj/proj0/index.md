...
title: "Project 0: 2048" # Title of page. 
categories: proj
...
![Opening the Project](img/intellij-pre-open.png)

![Opening the Project](img/intellij-open.png)
...
![Listed folders](img/list-files.png)
...
![IntelliJ error](img/intellij-error.png)
...
![Invalidate Caches](img/invalidate-caches.png)
...
To test your understanding, you should complete this [Google Form quiz](https://forms.gle/pubhRx4fxYnPTGNX8
). This quiz (and the following quizzes) are completely optional (i.e. no graded)
...
thing for the other three directions. If you do so naively, you'll get a *lot* of repeated, slightly modified code, with
