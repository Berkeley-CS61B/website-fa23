...
**INFO**: For this lab and course in general, we highly encourage that you try things out on your own first,
...
{% include alert.html type="info" content="
**INFO**: For this lab, we will be providing hints. Please **only use them if
